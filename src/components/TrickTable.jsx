      ...
      <table className="w-full text-xs sm:text-sm border-collapse">
        ...
        <thead>
          <tr className="bg-slate-800 border-b border-slate-700">
            <th scope="col" className="text-left p-1.5 sm:p-3 text-blue-400 font-medium">CODE</th>
            <th scope="col" className="text-left p-1.5 sm:p-3 text-blue-400 font-medium hidden md:table-cell">DESCRIPTION</th>
            <th scope="col" className="text-center p-1.5 sm:p-3 text-blue-400 font-medium hidden sm:table-cell">NO.</th>
            <th scope="col" className="text-center p-1.5 sm:p-3 text-blue-400 font-medium border-l border-slate-700 hidden sm:table-cell" colSpan="2">2 SKIS</th>
            <th scope="col" className="text-center p-1.5 sm:p-3 text-blue-400 font-medium border-l border-slate-700" colSpan="2">1 SKI</th>
          </tr>
          <tr className="bg-slate-800/50 border-b border-slate-700 text-xs">
            ...
            <th scope="col" className="text-center p-1 sm:p-2 text-gray-300 border-l border-slate-700 hidden sm:table-cell">B</th>
            <th scope="col" className="text-center p-1 sm:p-2 text-gray-300 hidden sm:table-cell">R</th>
            <th scope="col" className="text-center p-1 sm:p-2 text-gray-300 border-l border-slate-700">B</th>
            <th scope="col" className="text-center p-1 sm:p-2 text-gray-300">R</th>
          </tr>
        </thead>
        <tbody>
          {tricks.map((trick) => (
            <tr key={trick.code} className="border-b border-slate-700/50 hover:bg-slate-800/30">
              ...
              <td className="p-1.5 sm:p-3 text-center text-gray-300 hidden sm:table-cell">{trick.no}</td>
